        ...
        <div className="add_pin_modal">
            <div className="add_pin_container">
                <div className="side" id="left_side">
                    ...
                    <div className="section2">
                        <label htmlFor="upload_img" id="upload_img_label"
                            ...
                            <input onChange={event => upload_img(event, pinDetails, setPinDetails, setShowLabel, setShowModalPin)} 
                        ...
                        <div className="modals_pin"
                            ...
                            <div className="pin_image">
                                <img onLoad={check_size} src={pinDetails.picUrl} alt="pin_image" />
                            </div>
                        </div>
                    </div>
                ...
                <div className="side" id="right_side">
                    ...
                    <div className="section2">
                        <input placeholder="제목 추가" type="text" className="new_pin_input" id="pin_title" />
                        <input placeholder="사람들에게 회원님의 핀에 대해 설명해 보세요" type="text" className="new_pin_input" id="pin_content" />
                        <input placeholder="랜딩 페이지 링크 추가" type="text" className="new_pin_input" id="pin_destination" />
                    </div>
                </div>
            </div>
        </div>
