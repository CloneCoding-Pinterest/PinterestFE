...
function Pin(props) {
    return (
        <div className={`card card_${props.pinDetails.picSize}`}> {/* 이미지 크기 */} 
                ...
                <div className="modal_foot">
                    ...
                    <div className="author">
                        <div className="pint_mock_icon_container">
                            <img src="./images/profilePic.png" alt="author" className="pint_mock_icon" /> 
                        </div>
                    ...
                    <div className="title">
                        <div className="pint_mock_icon_container">
                            <img src="./images/title.png" alt="title" className="pint_mock_icon" />
                        </div>
                    ...
                    <div className="content">
                        <div className="pint_mock_icon_container">
                            <img src="./images/ellipse.png" alt="content" className="pint_mock_icon" />
                        </div>
            ...
            <div className="pin_image">
                <img onLoad={check_size} src={props.pinDetails.picUrl} alt="pin_image" />
            </div>
        </div>
    )
}
