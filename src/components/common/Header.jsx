      ...
      <header>
        <div className="contents_area">
          <Link to="/">
            {" "}
            {/* 메인 페이지로 이동 */}
            <span className="show_at_md">인터레스트</span>
          ...
          <div className="right">
            <Link to="/">
              ...
              <span className="hide_at_md">홈</span>
            </Link>
            ...
            {userLogin && (
              <>
                ...
                <Link to="/post">
                  {" "}
                  {/* "핀 만들기" 클릭 시 핀 생성 페이지로 이동 */}
                  <div className="show_at_md">
                    <MdCreate />
                  </div>
                  <div className="hide_at_md">핀 만들기</div>
                </Link>

                <div
                  className="btn"
                  onClick={() => {
                    // "로그아웃" 클릭 시 메인 페이지로 이동
            ...
            {!userLogin && (
              <>
                <Link to={"/sign/in"}>
                  ...
                  <span className="hide_at_md">로그인</span>
                </Link>
